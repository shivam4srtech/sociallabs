...
>
  ...
  <div class="jsx-72ce28f7fdf6d566 flex-1 flex justify-start">
    <a class="flex items-center group" href="/">
      <div class="relative w-[160px] h-[48px] transition-all duration-300 group-hover:scale-105">
       ...
       <span class="headerLogo">SocialLabs.in</span>
      </div>
    </a>
  </div>
      ...
      <div
                ...
                <li>
                  <button
                    class="w-full text-left flex items-center justify-between 
                           ...
                           hover:bg-slate-800/60 text-slate-200 hover:text-white"
                  >
                    <span class="truncate pr-2">Wireless Planning and Coordination (WPC)</span>
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="24"
                      height="24"
                ...
                <li>
                  <button
                    class="w-full text-left flex items-center justify-between 
                           ...
                           hover:bg-slate-800/60 text-slate-200 hover:text-white"
                  >
                    <span class="truncate pr-2">Food Safety and Standards Authority of India (FSSAI)</span>
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="24"
                      height="24"
                ...
                <li>
                  <button
                    class="w-full text-left flex items-center justify-between 
                           ...
                           hover:bg-slate-800/60 text-slate-200 hover:text-white"
                  >
                    <span class="truncate pr-2">Central Drugs Standard Control Organization (CDSCO)</span>
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="24"
                      height="24"
        ...
        <div class="headerTabContent flex-1 p-4 bg-slate-900/30 max-h-[calc(100vh-120px)] overflow-y-auto bg-blu" style="min-height:400px">
            ...
            <div class="headerContent">
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div class="group p-4 rounded-lg border border-slate-700/30 hover:border-blue-500/30 hover:shadow-lg hover:shadow-blue-500/10 transition-all duration-200 bg-slate-800/20 hover:bg-slate-800/40">
                    <a class="font-semibold text-slate-100 group-hover:text-blue-400 block transition-colors duration-200 mb-2" href="/wpc">WPC Approvals and Licenses</a>
                  </div>
              </div>
            </div>
            <div class="headerContent">
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div class="group p-4 rounded-lg border border-slate-700/30 hover:border-blue-500/30 hover:shadow-lg hover:shadow-blue-500/10 transition-all duration-200 bg-slate-800/20 hover:bg-slate-800/40">
                    <a class="font-semibold text-slate-100 group-hover:text-blue-400 block transition-colors duration-200 mb-2" href="/fssai">FSSAI Approval</a>
                  </div>
              </div>
            </div>
            <div class="headerContent">
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div class="group p-4 rounded-lg border border-slate-700/30 hover:border-blue-500/30 hover:shadow-lg hover:shadow-blue-500/10 transition-all duration-200 bg-slate-800/20 hover:bg-slate-800/40">
                    <a class="font-semibold text-slate-100 group-hover:text-blue-400 block transition-colors duration-200 mb-2" href="/medical">CDSCO- Medical Device Registration</a>
                  </div>
                  <div class="group p-4 rounded-lg border border-slate-700/30 hover:border-blue-500/30 hover:shadow-lg hover:shadow-blue-500/10 transition-all duration-200 bg-slate-800/20 hover:bg-slate-800/40">
                    <a class="font-semibold text-slate-100 group-hover:text-blue-400 block transition-colors duration-200 mb-2" href="/cosmetics">Cosmetic Manufacturing License</a>
                  </div>
              </div>
            </div>
            <div class="headerContent">
  ...
  <footer class="bg-slate-900 text-slate-300 pageFooter">
        ...
        <div class="block md:hidden">
            ...
            <div class="mb-8">
                ...
                <div class="space-y-4 text-sm text-slate-400">
                    <div>
                        ...
                        <p>Floor 405, Maheshwari Chambers, <br> Irram Manzil Colony, Punjagutta, Hyderabad, Telangana 500082.</p>
                    </div>
            ...
            <div class="mb-8">
                ...
                <div class="flex space-x-4">
                    {{-- Twitter / X --}}
                    <a href="https://x.com/Sociallabs.inlabs" target="_blank" rel="noopener noreferrer" aria-label="Twitter" class="w-10 h-10 bg-slate-800 rounded-full flex items-center justify-center text-slate-400 hover:bg-slate-700 hover:text-white transition-all duration-300">
                        <i class="fa-brands fa-x-twitter"></i>
                    </a>
                    {{-- Instagram --}}
                    <a href="https://www.instagram.com/Sociallabs.in.in/?hl=en" target="_blank" rel="noopener noreferrer" aria-label="Instagram" class="w-10 h-10 bg-slate-800 rounded-full flex items-center justify-center text-slate-400 hover:bg-slate-700 hover:text-white transition-all duration-300">
                        <i class="fa-brands fa-instagram"></i>
                    </a>
                    {{-- LinkedIn --}}
                    <a href="https://www.linkedin.com/company/Sociallabs.inin/posts/?feedView=all" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" class="w-10 h-10 bg-slate-800 rounded-full flex items-center justify-center text-slate-400 hover:bg-slate-700 hover:text-white transition-all duration-300">
                        <i class="fa-brands fa-linkedin-in"></i>
                    </a>
                    {{-- YouTube --}}
                    <a href="https://www.youtube.com/@Sociallabs.inIndia" target="_blank" rel="noopener noreferrer" aria-label="YouTube" class="w-10 h-10 bg-slate-800 rounded-full flex items-center justify-center text-slate-400 hover:bg-slate-700 hover:text-white transition-all duration-300">
                        <i class="fa-brands fa-youtube"></i>
                    </a>
                    {{-- Facebook --}}
                    <a href="https://www.facebook.com/Sociallabs.inIndia/" target="_blank" rel="noopener noreferrer" aria-label="Facebook" class="w-10 h-10 bg-slate-800 rounded-full flex items-center justify-center text-slate-400 hover:bg-slate-700 hover:text-white transition-all duration-300">
            ...
            <div class="grid grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
                ...
                <div class="lg:col-span-1">
                    ...
                    <div class="flex space-x-4 socialIcons">
                        ...
                        <a href="https://www.instagram.com/Sociallabs.in.in/?hl=en" target="_blank" rel="noopener noreferrer" class="w-10 h-10 flex items-center justify-center rounded-full bg-slate-800 text-slate-400 hover:bg-slate-700 hover:text-white transition">
                        ...
                        <a href="https://www.linkedin.com/company/Sociallabs.inin/posts/?feedView=all" target="_blank" rel="noopener noreferrer" class="w-10 h-10 flex items-center justify-center rounded-full bg-slate-800 text-slate-400 hover:bg-slate-700 hover:text-white transition">
                        ...
                        <a href="https://www.youtube.com/@Sociallabs.inIndia" target="_blank" rel="noopener noreferrer" class="w-10 h-10 flex items-center justify-center rounded-full bg-slate-800 text-slate-400 hover:bg-slate-700 hover:text-white transition">
                        ...
                        <a href="https://www.facebook.com/Sociallabs.inIndia/" target="_blank" rel="noopener noreferrer" class="w-10 h-10 flex items-center justify-center rounded-full bg-slate-800 text-slate-400 hover:bg-slate-700 hover:text-white transition">
